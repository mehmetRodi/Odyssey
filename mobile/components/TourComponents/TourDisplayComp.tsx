...
export default function TourDisplayComp({ image, title, author, duration, length, reviewCount, rating}: TourDisplayProps) {
    ...
    <View style={styles.card}>
      ...
      <View style={styles.infoContainer}>
        <View style={styles.header}>
          ...
          <Text style={styles.rating}>{STAR}{rating}/5</Text>
        </View>
